        ...
        <div class="content ">
          ...
          <div class="container-fluid container-fixed-lg">
            <!-- BEGIN PlACE PAGE CONTENT HERE -->
              <h1 class="text-center header-of-page">借阅记录</h1>
                        ...
                        for($i = 0;$i<count($result);$i++) {
                            ...
                            if ($row['status'] == "在读"){
                              echo "<td class='v-align-middle'>
                                    <a class='btn btn-primary' href='return_book.php?uname=$uname&book_id=$book_id' role='button'>还书</a>
                                </td>";
                            }else{
                              echo "<td class='v-align-middle'>
                                    <a class='btn btn-primary disabled' href='' role='button'>还书</a>
                                </td>";
                            }
                            echo "</tr>";
                          }
