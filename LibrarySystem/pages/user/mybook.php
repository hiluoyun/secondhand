        ...
        <div class="content ">
          ...
          <div class="container-fluid container-fixed-lg">
            <!-- BEGIN PlACE PAGE CONTENT HERE -->
              <h1 class="text-center header-of-page">我的图书</h1>
                  ...
                  <tbody>
                    ...
                    require_once('../control/booklist.php');
                        ...
                        if($_POST) {
                            ...
                            $result = search_mybook($searchby,$search,$uname);
                            while ( $row = $result->fetch_assoc() ) {
                              $book_id = $row['id'];
                              $status = "借出";
                              if ($row['status'] == 1){
                              ...
                              echo "<tr>
                                    ...
                                    echo " href='downbook.php?uname=$uname&book_id=$book_id' role='button'>下架</a>
                                    </td>
                                </tr>";
                                }
                        }
                        else {
                            $result = list_mybook($uname);
