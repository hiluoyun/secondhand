              ...
              <div class="panel-body">
                <table class="table table-hover demo-table-dynamic" id="tableWithDynamicRows">
                  ...
                  <tbody>
                    ...
                    <a class='btn btn-sm btn-block btn-success'  href='update_book.php?book_id=$book_id' role='button'>修改</a>
                                        <a class='btn btn-sm btn-block btn-warning'  href='delete_book.php?uname=$uname&book_id=$book_id' role='button'>删除</a>
                                    </td>
                                  </tr>";
                                }
                        }
