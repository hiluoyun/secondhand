        ...
        <div class="content ">
          ...
          <div class="container-fluid container-fixed-lg">
            <!-- BEGIN PlACE PAGE CONTENT HERE -->
              <h1 class="text-center header-of-page">管理员列表</h1>
              <div class="panel panel-transparent">
              <form method="POST">
                  <div class="panel-heading">
                    <div class="form-group m-b-10 col-md-3">
                        <input type="text" name="search" placeholder="查询用户..." class="form-control">
                    </div>
                    <div class="col-md-1">
                          ...
                          <div class="cs-wrapper">
                              <div class="cs-select cs-skin-slide" tabindex="0">
                                  <div class="cs-options" style="width: auto; overflow-y: hidden;">
                                      <ul>
                                          <li data-option="" data-value="name" class="">
                                              <span>名字</span>
                                          </li>
                                          <li data-option="" data-value="phone" class="">
                                              <span>手机</span>
                                          </li>
                                      </ul>
                                  </div>
                    ...
                    require_once('../control/booklist.php');
                        if($_POST) {
                            ...
                            $searchby = $_POST['searchby'];
                                $result = user_search(1,$searchby,$search);
                                $i = 1;
                                while ( $row = $result->fetch_array() ) {
                                  $name = $row['username'];
                                    echo "<tr>
                                                ...
                                                <td>
                                                <a class='btn btn-sm  btn-warning'  href='delete_mem.php?uname=$name' role='button'>删除</a>
                                                </td>
                                            </tr>";
                                            $i++;
                                }
