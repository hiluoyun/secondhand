      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          ...
          <form id="form-login" method="POST" class="p-t-15" role="form">
            ...
            <button class="btn btn-primary btn-cons m-t-10 log_in" type="submit" onClick="location.href='../user/usr.php'"> 登录 </button>
            <button class="btn btn-primary btn-cons m-t-10 log_in" type="submit" onClick="location.href='../../index.php'"> 取消 </button>
          </form>
          <!--END Login Form-->
        </div>
      </div>
