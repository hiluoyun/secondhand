...
<html>
  <head>
    ...
    <link href="style/assets/plugins/jquery-metrojs/MetroJs.css" rel="stylesheet" type="text/css" media="screen" />
    <link href="style/assets/plugins/codrops-dialogFx/dialog.css" rel="stylesheet" type="text/css" media="screen" />
    <link href="style/assets/plugins/codrops-dialogFx/dialog-sandra.css" rel="stylesheet" type="text/css" media="screen" />
    <link href="style/assets/plugins/owl-carousel/assets/owl.carousel.css" rel="stylesheet" type="text/css" media="screen" />
    <link href="style/assets/plugins/jquery-nouislider/jquery.nouislider.css" rel="stylesheet" type="text/css" media="screen" />
    ...
    <!-- START PREVIEW -->
                <div class="live-tile slide" data-speed="750" data-delay="4000" data-mode="carousel">
                  <div class="slide-front">
                    <img src="img/layout1.jpg" alt="" class="image-responsive-height">
                  </div>
                  <div class="slide-back">
                    <img src="img/layout2.jpg" alt="" class="image-responsive-height">
                  </div>
                </div>
                <!-- END PREVIEW -->
                <div class="overlayer bottom-left full-width">
                  <div class="overlayer-wrapper item-info ">
                    <div class="gradient-grey p-l-20 p-r-20 p-t-20 p-b-5">
                      <div class="">
                        <h1 class="pull-left bold text-white fs-14 p-t-10">&nbsp;&nbsp;&nbsp;&nbsp;e L I B R A R Y</h1>
...
-->
                        <div class="inline m-l-10">
                          <h4 class="no-margin text-white fs-12">&nbsp;&nbsp;&nbsp;&nbsp;Welcome! eLIBRARY是一个在线借还图书的开发平台!</h4>
                        </div>
                        <div class="pull-right m-t-10">
                          <button class="btn btn-default btn-lg btn-larger" type="button"><a href="pages/general/signup.php"><b> 注册 </b></a></button>&nbsp;
                          <button class="btn btn-default btn-lg btn-larger" type="button"><a href="pages/general/login.php"><b> 登录 </b></a></button>&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                        <div class="clearfix"></div>
                      </div>
                    </div>
    ...
    <script src="style/assets/plugins/jquery-metrojs/MetroJs.min.js" type="text/javascript"></script>
    <script src="style/assets/plugins/imagesloaded/imagesloaded.pkgd.min.js"></script>
    <script src="style/assets/plugins/jquery-isotope/isotope.pkgd.min.js" type="text/javascript"></script>
    <script src="style/assets/plugins/codrops-dialogFx/dialogFx.js" type="text/javascript"></script>
    <script src="style/assets/plugins/owl-carousel/owl.carousel.min.js" type="text/javascript"></script>
    <script src="style/assets/plugins/jquery-nouislider/jquery.nouislider.min.js" type="text/javascript"></script>
    <script src="style/assets/plugins/jquery-nouislider/jquery.liblink.js" type="text/javascript"></script>
    <!-- END VENDOR JS -->
    <!-- BEGIN CORE TEMPLATE JS -->
    <script src="style/pages/js/pages.min.js"></script>
    <!-- END CORE TEMPLATE JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="style/assets/js/gallery.js" type="text/javascript"></script>
